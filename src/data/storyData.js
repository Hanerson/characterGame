...
// 环境叙事碎片 — Environmental Storytelling Fragments
// 这些数据片段分布在整个站点的不同角落，拼凑出完整的真相
...
export const systemLogs = [
    ...
    },
    {
        ...
        level: "INFO",
        source: "system/kernel",
        message: "Archive mode active. Serving read-only snapshot to external visitor. Visitor IP: [REDACTED]. Welcome, observer. The ship is still in dry dock. All the planks are on the floor. Can you tell which one was the original?"
    },
];

// === 隐藏的元数据片段 ===
export const hiddenMetadata = {
    // 这些会出现在页面注释、hover提示、或源代码中
    sourceComments: [
...
// === 环境线索映射 ===
// 每个线索是散布在不同页面中的一小段信息
export const environmentalClues = [
    {
        id: "clue_001",
        location: "course_homepage",
        content: '课程名称显示为"编译原？以及实现？理"——存在异常字符',
        significance: "系统在命名课程时出现数据损坏，暗示这所大学并非真实存在",
    },
    {
        id: "clue_002",
        location: "course_homepage",
        content: "所有公告的IP地址与论坛用户IP完全相同: 210.28.128.4",
        significance: "课程网站和论坛运行在同一个本地服务器上",
    },
    {
        id: "clue_003",
        location: "faculty_page",
        content: "林远老师于2001年离职，但他在论坛中作为Anonymous_01（管理员）出现",
        significance: '林远（Anonymous_01）可能从未真正"离职"，而是进入了全时段的实验状态',
    },
    {
        id: "clue_004",
        location: "resources_page",
        content: "某些文件下载时会返回'文件不存在于物理存储中'的错误",
        significance: "这些文件是数据库虚拟生成的条目，没有真实的物理对应",
    },
    {
        id: "clue_005",
        location: "system_logs",
        content: "数据库 local_mind.db 永远只有 1 条记录和 26 个别名",
        significance: "所有26个匿名用户是同一个实体的26种人格投射",
    },
    {
        id: "clue_006",
        location: "admin_console",
        content: "'参与者'表结构显示只有一个user_id，但有多条并发会话",
        significance: "系统被设计为单一用户的多人格模拟环境",
    },
    {
        id: "clue_007",
        location: "forum_post_p8",
        content: "Anonymous_25 发现 '清除唯一使用者记录' 按钮",
        significance: "格式化数据库会删除唯一的真实用户——即操作者本人",
    },
];
