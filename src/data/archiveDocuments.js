...
export const archiveContents = {
  ...
  "exported_by": "设备科"
    ...
    '2021-archaeology-project': {
        ...
        archiveNote:
            '这篇考古计划文章是整条叙事的外层框架。它解释了玩家/访客所看到的全部碎片是如何被发现的——不是通过官方档案查询，也不是某个知情人统一发布的，而是通过互联网上分散的、互不相关的存档和泄漏，被一个疫情期间的陌生人偶然串联起来的。这种发现方式本身也是故事的一部分：林远从未试图留下一个完整的"传记"，他只留下了痕迹。痕迹被时间打散，然后被另一个人捡起来，排成了一条线。',
    },
};
